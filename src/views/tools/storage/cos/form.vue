<template>
  <el-dialog :visible.sync="dialog" :close-on-click-modal="false" title="腾讯云cos配置" append-to-body width="580px">
    <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px;" size="small" label-width="110px">
      ...
      <el-form-item label="外链域名" prop="host">
        <el-input v-model="form.host" style="width: 95%;" placeholder="外链域名，可自定义，需在腾讯云cos绑定" />
      </el-form-item>
...
export default {
  data() {
    return {
      regions: ['ap-beijing', 'ap-nanjing', 'ap-shanghai', 'ap-guangzhou', 'ap-chengdu', 'ap-chongqing'], dialog: false,
